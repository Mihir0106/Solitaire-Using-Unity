...
public class Solitaire : MonoBehaviour
{
    ...
    public void DealFromDeck()
    {
        ...
        if (deckLocation < trips)
        {
            ...
            {
                GameObject newTopCard = Instantiate(cardPrefab, new Vector3(deckButton.transform.position.x + xOffset, deckButton.transform.position.y,
