...
public static class History
{
    ...
    // A flipped card has to be added to the current history step, 
    //if a card gets moved away from a main pile and there is a card underneath it that is turned on its back.
